            ...
            switch (_b.label) {
                case 0:
                    switch (key) {
                        ...
                        case "sms_portal": return [3 /*break*/, 14];
                    }
                    return [3 /*break*/, 7];
                ...
                case 14: return [4 /*yield*/, Promise.resolve().then(function () { return require("./providers/smsPortalProvider"); })];
                case 15:
                    mod = _b.sent();
                    return [2 /*return*/, new mod.SmsPortalProvider()];
            }
        });
    });
}
